...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/11/21 22:40:14 by rsenelle          #+#    #+#             */
/*   Updated: 2021/12/14 20:26:17 by rsenelle         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
* counting number of stings in massive of map
*/
...
/*
* check if the file opened, if the map can be read and if map extention is .ber
*/
